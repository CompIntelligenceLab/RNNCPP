...
public:
  ...
  CONNECTIONS& getSpatialConnections() { return clist; }
  ...
  // return prediction
  // does not work if I return a reference because the memory is released inside the module. 
  VF2D_F trainOneBatch(VF2D_F& x, VF2D_F& y);
